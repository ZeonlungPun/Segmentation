...
#                (file_name, extension) = os.path.splitext(res)
    ...
    def image(self, data, num, json_path):
        ...
        image['width'] = width
        image['id'] = int(num + 1)
        image_save_path='../'+image_path.split('/')[-2]+'/'+image_path.split('/')[-1]
        image['file_name'] = image_save_path
...
if __name__ == "__main__":
    ...
    labelme_folder = r"/home/kingargroo/fungs_rect_imgs/coco2/train2017"
    #save_json_path 转换生成的coco格式的标签文件的保存路径
    save_json_path = r"/home/kingargroo/fungs_rect_imgs/instances_train2017.json"
